...
const AddEvent = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await eventService.bookEvent(submitData);
      navigate('/events');
    } catch (error) {
  ...
  return (
    <div className="event-form fade-in">
      ...
      <div className="form-container card">
        <h1 className="form-title">Book New Event</h1>
        <p className="form-subtitle">Fill in the details below to book a new event</p>
