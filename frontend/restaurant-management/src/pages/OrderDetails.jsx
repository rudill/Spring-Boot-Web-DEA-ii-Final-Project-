...
import { ArrowLeft, Trash2, Clock, Flame, CheckCircle, CheckCheck, Hash, LayoutGrid, DollarSign, MessageSquare } from 'lucide-react';
      ...
      <div className="details-container">
        <div className="order-header card">
          ...
          <div className="order-info">
            ...
            <p className="order-table">Table ID: #{order.tableId || 'N/A'}</p>
            ...
            {getStatusSteps().map((step, index) => (
              <div key={step.label} className={`progress-step ${step.completed ? 'completed' : ''} ${step.current ? 'current' : ''}`}>
                <div className="step-icon">
                  ...
                  {step.label === 'PREPARING' && <Flame size={20} />}
        ...
        <div className="details-grid">
          ...
          <div className="detail-card card">
            ...
            <div className="detail-content">
              ...
              <span className="detail-value">#{order.tableId || 'N/A'}</span>
            </div>
          </div>
          ...
          {order.specialNotes && (
            <div className="detail-card card">
              ...
              <div className="detail-content">
                ...
                <span className="detail-value">{order.specialNotes}</span>
              </div>
            </div>
          )}
        </div>
